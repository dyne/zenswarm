...
### Start Ethereum to Planetmint Notarization
...
When I rename the 'newblock' to 'asset'
...
"> ./contracts/ethereum-to-planetmint-3.zen
echo ✔ Imported ethereum-to-planetmint-3.zen

echo "{\"endpoint\":\"http://3.66.221.17/api/v1/\",\"ed25519_keypair\":{\"private_key\":\"5Jgk9ARKbPXRwPCuVHv94M4q9iKpF67Apk6hP3rRLtby\",\"public_key\":\"Mx2D1WbAdREJphfuAcRCge54zMndKfmozynzRZYP5aw\"},\"metadata\":{\"origin\":\"zenswwarm\",\"ruler\":\"Dyne.org\",\"type\":\"notarization of ethereum block onto planetmint\"}}" > ./contracts/ethereum-to-planetmint-3.keys
echo ✔ Imported ethereum-to-planetmint-3.keys

echo "
Given I have a 'string' named 'planetmint_transaction'
Given I have a 'string' named 'txId'
Given I have a 'string dictionary' named 'asset'
Then print data
"> ./contracts/ethereum-to-planetmint-4.zen
echo ✔ Imported ethereum-to-planetmint-4.zen
...
blocks:
  ...
  id_2:
    ...
    next: id_3
  id_3:
    zenFile: ethereum-to-planetmint-3.zen
    keysFile: ethereum-to-planetmint-3.keys
    next: id_4
  id_4:
    zenFile: ethereum-to-planetmint-4.zen

"> ./contracts/ethereum-to-planetmint-notarization.yml
echo ✔ Imported ethereum-to-planetmint-notarization.yml


### End Ethereum to Planetmint Notarization


### Start Sawroom to Planetmint Notarization
...
"> ./contracts/sawroom-to-planetmint-3.zen
echo ✔ Imported sawroom-to-planetmint-3.zen

echo "{\"endpoint\":\"http://3.66.221.17/api/v1/\",\"ed25519_keypair\":{\"private_key\":\"5Jgk9ARKbPXRwPCuVHv94M4q9iKpF67Apk6hP3rRLtby\",\"public_key\":\"Mx2D1WbAdREJphfuAcRCge54zMndKfmozynzRZYP5aw\"},\"metadata\":{\"origin\":\"zenswwarm\",\"ruler\":\"Dyne.org\",\"type\":\"notarization of ethereum block onto planetmint\"}}" > ./contracts/sawroom-to-planetmint-3.keys
echo ✔ Imported sawroom-to-planetmint-3.keys
